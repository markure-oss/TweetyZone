<?php 
  ...
  // Database::instance()->prepare("SELECT * FROM `users`");
?>
<section class="main-page">
  <!-- left -->
  <div class="left">
    <div class="left-content p-center">
      <svg class="left-content-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g>
          <path
  ...
  <div class="right">
    <div class="right-side-wrapper">
      <svg class="left-content-icon" style="width: 45px; height: 57px;fill:rgb(29,161,242);"
    ...
    <div class="right-middle-content">
      ...
      <div class="s-i-wrapper">
        <a href="sign" class="btn-link sign-up-btn">Sign Up</a>
        <a href="login" class="btn-link log-in-btn">Login In</a>
      </div>
    </div>
  </div>
  <!-- end right -->
